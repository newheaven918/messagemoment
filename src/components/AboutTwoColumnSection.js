...
const AboutTwoColumnSection = ({ bg, classes = '', title, des, pr, imgClass = '', main = '', downarrow = false }) => {
  return (
    <div className={`border-t bg-gradient-to-b from-blue-10 from-0% via-blue-0 via-60% to-white to-90% ${main}`}>
      ...
      <div className={`flex sm:justify-center ${classes} lg:items-center gap-6 lg:gap-[15px] max-lg:flex-col`}>
        ...
        <div className="flex sm:justify-center sm:items-center flex-col  ">
          ...
          <p className="font-jetBrain text-[13px] lg:text-[17px] font-medium mt-[22px] max-w-[576px] pr-[50px] leading-[22px] tracking-[0.1px]">{des}</p>
        </div>
      </div>
    </div>
  );
