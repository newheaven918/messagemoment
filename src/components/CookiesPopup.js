            ...
            <div className="w-full lg:w-[440px] lg:absolute lg:right-2 lg:bottom-0 mb-[10px] lg:my-6 mx-auto max-w-3xl bg-white border border-black border-opacity-10 rounded-[10px]">
              ...
              <div className="border-0 rounded-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-center justify-between px-5 pb-5 lg:p-6 gap-2 border-black border-opacity-10 rounded-b">
                  <button className="bg-blue font-jetBrain text-[15px] w-[180px] h-[46px] rounded-md text-white ease-linear transition-all duration-250 hover:bg-opacity-80" type="button" onClick={cookiesAccepted}>
                    Accept All
                  </button>
                  <button className="bg-lightGrey font-jetBrain text-[15px] w-[180px] h-[46px] rounded-md text-dark ease-linear transition-all duration-250 hover:bg-opacity-80" type="button" onClick={cookiesRejected}>
                    Reject All
                  </button>
                </div>
              </div>
