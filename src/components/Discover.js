  ...
  return (
    <div className="bg-dark px-[15px]">
      <div className="max-w-[1318px] mx-auto">
        <h2 className="font-bold text-[34px] text-center lg:text-[60px] tracking-[-.5px] lg:tracking-[2px] sm:max-w-[450px] lg:max-w-[934px] mx-auto text-white lg:leading-[70px] pt-14 pb-8 lg:pt-[70px] lg:pb-[40px]">Discover more from MessageMoment</h2>
        <DiscoverSlider />
        <p className="text-white text-[26px] text-center mt-10 lg:mt-[56px] mb-9 lg:tracking-[0.75px]">
          Use MessageMoment on any device via Browser<sup className="text-[60%]">1</sup>
        </p>
        <div className="flex justify-center gap-5 lg:gap-[48px] pb-10 pr-[9px] pl-[2px] pt-[1px] lg:pb-[58px] ">
          <div className="device text-center w-[48px]">
            <svg className="w-[36px] h-[36px] mb-5 lg:h-[48px] ml-[12px] lg:w-[28px] mx-auto" xmlns="http://www.w3.org/2000/svg" width="28" height="44" viewBox="0 0 28 44" fill="none">
            ...
            <p className="text-white pl-[1px] w-[45px]">Phone</p>
          </div>
          <div className="device text-center w-[63px]">
            <svg className="w-[36px] h-[36px] mb-5 lg:h-[48px] lg:w-[55px] ml-[3px] mx-auto" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
          ...
          <div className="device text-center w-[55px]">
          ...
          <div className="device text-center w-[74px]">
            <svg className="w-[36px] h-[36px] mb-5 mr-[13px] lg:h-[48px] lg:w-[48px] mx-auto" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
          ...
          <div className="device text-center">
            <svg className="w-[36px] pl-[3px] h-[36px] mb-5 lg:h-[48px] lg:w-[48px] mx-auto" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
        ...
        <div className="disclaimer max-w-[1096px] mx-auto pt-[19px] border-t border-t-white border-opacity-20 pb-[34px] text-center">
