...
const LinkGenerate = () => {
  ...
  function handleQrTip() {
    setShowQRTip(true);
  }

  function handleQrTipLeave() {
    setShowQRTip(false);
  }
  ...
  return (
    <>
      <div className="bg-blue max-w-[1096px] rounded-[20px] absolute z-50 -bottom-[400px] lg:-bottom-[112px] left-[15px] right-[15px] lg:right-auto lg:left-1/2 lg:transform lg:-translate-x-1/2 lg:w-full mx-auto" id="linkGenerate">
        <p className="pt-[30px] pb-[30px] font-medium text-sm lg:text-[17px] max-w-[261px] pl-[2px] mx-auto lg:max-w-none text-white text-center tracking-[0.05px]">Click the button below to receive your random link that you can share with your friends any way you like!</p>
        <div className="link bg-black bg-opacity-20 rounded-[0_0_20px_20px] pt-[18px] px-[15px]  lg:px-[30px] lg:pt-[35px] lg:pb-[15px] pb-5">
          <div className="bg-white rounded-[5px] overflow-hidden lg:overflow-visible lg:bg-transparent lg:rounded-none">
            <div className="flex ">
              <div className={`flex items-center w-[60px] lg:w-[140px] rounded-[5px_0_0_${selectList ? '0' : '5px'}] lg:rounded-[5px_0_0_5px ] bg-white h-[50px] border-r-[1px] border-r-[#DDDD] relative`}>
                {secure ? (
                  <>
                  ...
                  <>
                    <div className="items-center flex-1 pr-[15px] hidden lg:flex">
                      <svg className="ml-3 mr-[9px]" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                      ...
                      <div className="cursor-pointer pt-[2px] flex items-center justify-between handle-select" onClick={handleSelect}>
                        <p className="mr-[9px]  text-dark hover:text-opacity-70 hidden lg:block tracking-[0.6px]">Standard</p>
                        <svg className="" xmlns="http://www.w3.org/2000/svg" width="15" height="9" viewBox="0 0 13 6" fill="none">
                          <path d="M8.01986 0.201134C8.15 0.0722816 8.32573 0 8.50886 0C8.692 0 8.86773 0.0722816 8.99786 0.201134C9.06211 0.264407 9.11314 0.339828 9.14796 0.423006C9.18279 0.506184 9.20073 0.595459 9.20073 0.685634C9.20073 0.775809 9.18279 0.865083 9.14796 0.948261C9.11314 1.03144 9.06211 1.10686 8.99786 1.17013L5.08986 5.00013C4.95943 5.12881 4.78358 5.20095 4.60036 5.20095C4.41714 5.20095 4.24129 5.12881 4.11086 5.00013L0.202863 1.17013C0.138613 1.10686 0.0875897 1.03144 0.0527625 0.948261C0.0179353 0.865083 0 0.775809 0 0.685634C0 0.595459 0.0179353 0.506184 0.0527625 0.423006C0.0875897 0.339828 0.138613 0.264407 0.202863 0.201134C0.332997 0.0722816 0.50873 0 0.691863 0C0.874996 0 1.05073 0.0722816 1.18086 0.201134L4.60186 3.34213L8.01986 0.201134Z" fill="#363C4F" />
                        </svg>
                      </div>
                    </div>
                    <div onClick={handleSelect} className="flex items-center flex-1 pr-[15px] lg:hidden">
                      ...
                      <div className="cursor-pointer flex items-center justify-between handle-select">
                        <p className="mr-[10px] text-dark hover:text-opacity-70 hidden lg:block font-dm tracking-[0.5px]">Standard</p>
                        <svg className="" xmlns="http://www.w3.org/2000/svg" width="15" height="9" viewBox="0 0 11 6" fill="none">
                          <path d="M1.17936 5.00199C1.04922 5.13084 0.873489 5.20312 0.690356 5.20312C0.507223 5.20312 0.331491 5.13084 0.201356 5.00199C0.137106 4.93872 0.0860825 4.8633 0.0512553 4.78012C0.016428 4.69694 -0.00150675 4.60767 -0.00150675 4.51749C-0.00150674 4.42732 0.0164281 4.33804 0.0512553 4.25486C0.0860825 4.17168 0.137106 4.09626 0.201356 4.03299L4.10936 0.202991C4.23979 0.0743175 4.41564 0.00217491 4.59886 0.00217493C4.78207 0.00217494 4.95793 0.0743176 5.08836 0.202991L8.99636 4.03299C9.06061 4.09626 9.11163 4.17169 9.14646 4.25486C9.18128 4.33804 9.19922 4.42732 9.19922 4.51749C9.19922 4.60767 9.18128 4.69694 9.14646 4.78012C9.11163 4.8633 9.06061 4.93872 8.99636 5.00199C8.86622 5.13084 8.69049 5.20312 8.50736 5.20312C8.32422 5.20312 8.14849 5.13084 8.01836 5.00199L4.59736 1.86099L1.17936 5.00199Z" fill="#363C4F" />
                        </svg>
                      </div>
                    </div>
                  </>
                )}
                <div className={`select absolute  top-full left-0 w-full  z-20 hidden border-t border-b border-r border-light-gray ${selectList ? 'lg:block' : 'lg:hidden'}`}>
                  <div className="items-center flex-1 h-[47px] pr-[15px] hidden lg:flex py-2  bg-white">
                    <svg className="ml-3 mr-[9px]" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                      <path d="M11.488 9.6C11.552 9.072 11.6 8.544 11.6 8C11.6 7.456 11.552 6.928 11.488 6.4H14.192C14.32 6.912 14.4 7.448 14.4 8C14.4 8.552 14.32 9.088 14.192 9.6M10.072 14.048C10.552 13.16 10.92 12.2 11.176 11.2H13.536C12.768 12.52 11.544 13.544 10.072 14.048ZM9.872 9.6H6.128C6.048 9.072 6 8.544 6 8C6 7.456 6.048 6.92 6.128 6.4H9.872C9.944 6.92 10 7.456 10 8C10 8.544 9.944 9.072 9.872 9.6ZM8 14.368C7.336 13.408 6.8 12.344 6.472 11.2H9.528C9.2 12.344 8.664 13.408 8 14.368ZM4.8 4.8H2.464C3.224 3.472 4.456 2.448 5.92 1.952C5.44 2.84 5.08 3.8 4.8 4.8ZM2.464 11.2H4.8C5.08 12.2 5.44 13.16 5.92 14.048C4.456 13.544 3.224 12.52 2.464 11.2ZM1.808 9.6C1.68 9.088 1.6 8.552 1.6 8C1.6 7.448 1.68 6.912 1.808 6.4H4.512C4.448 6.928 4.4 7.456 4.4 8C4.4 8.544 4.448 9.072 4.512 9.6M8 1.624C8.664 2.584 9.2 3.656 9.528 4.8H6.472C6.8 3.656 7.336 2.584 8 1.624ZM13.536 4.8H11.176C10.92 3.8 10.552 2.84 10.072 1.952C11.544 2.456 12.768 3.472 13.536 4.8ZM8 0C3.576 0 0 3.6 0 8C0 10.1217 0.842855 12.1566 2.34315 13.6569C3.08601 14.3997 3.96793 14.989 4.93853 15.391C5.90914 15.7931 6.94943 16 8 16C10.1217 16 12.1566 15.1571 13.6569 13.6569C15.1571 12.1566 16 10.1217 16 8C16 6.94943 15.7931 5.90914 15.391 4.93853C14.989 3.96793 14.3997 3.08601 13.6569 2.34315C12.914 1.60028 12.0321 1.011 11.0615 0.608964C10.0909 0.206926 9.05058 0 8 0Z" fill="#CCCCCC" />
                    </svg>{' '}
                    <div className="cursor-pointer pt-[2px] flex items-center justify-between handle-select" onClick={handleStandard}>
                      <p className="mr-[9px]  text-dark hover:text-opacity-70 hidden lg:block tracking-[0.6px]">Standard</p>
                    </div>
                  </div>
                  <div className="items-center flex-1 pr-[15px] h-[47px] hidden lg:flex border-t border-b border-light-gray bg-white  py-2 text-[13px] lg:text-[15px] font-jetBrain">
                    <svg className="ml-[14px] mr-[9px]"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            width="13" height="16" viewBox="0 0 13 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.52381 16C1.10476 16 0.745906 15.8507 0.447239 15.552C0.148573 15.2533 -0.000506643 14.8947 1.29356e-06 14.4762V6.85714C1.29356e-06 6.4381 0.149334 6.07924 0.448001 5.78057C0.746668 5.4819 1.10527 5.33283 1.52381 5.33333H2.28572V3.80952C2.28572 2.75556 2.65727 1.85702 3.40038 1.11391C4.14349 0.370794 5.04178 -0.000507416 6.09524 5.20427e-07C7.14921 5.20427e-07 8.04775 0.371556 8.79086 1.11467C9.53397 1.85778 9.90527 2.75606 9.90476 3.80952V5.33333H10.6667C11.0857 5.33333 11.4446 5.48267 11.7432 5.78133C12.0419 6.08 12.191 6.4386 12.1905 6.85714V14.4762C12.1905 14.8952 12.0411 15.2541 11.7425 15.5528C11.4438 15.8514 11.0852 16.0005 10.6667 16H1.52381ZM6.09524 12.1905C6.51429 12.1905 6.87314 12.0411 7.17181 11.7425C7.47048 11.4438 7.61956 11.0852 7.61905 10.6667C7.61905 10.2476 7.46972 9.88876 7.17105 9.5901C6.87238 9.29143 6.51378 9.14235 6.09524 9.14286C5.67619 9.14286 5.31733 9.29219 5.01867 9.59086C4.72 9.88952 4.57092 10.2481 4.57143 10.6667C4.57143 11.0857 4.72076 11.4446 5.01943 11.7432C5.3181 12.0419 5.6767 12.191 6.09524 12.1905ZM3.80953 5.33333H8.38095V3.80952C8.38095 3.1746 8.15873 2.63492 7.71429 2.19048C7.26984 1.74603 6.73016 1.52381 6.09524 1.52381C5.46032 1.52381 4.92064 1.74603 4.47619 2.19048C4.03175 2.63492 3.80953 3.1746 3.80953 3.80952V5.33333Z" fill="#CCCCCC"/>
                    </svg>
                    <div onClick={handleSecure}>
                      <p className="mr-[9px] text-[16px] text-dark hover:text-opacity-70 hidden lg:block tracking-[0.6px] pt-[2px] pl-[1px] " >Secure</p>
                    </div>
                  </div>
                  
                  {/* <div onClick={handleSecure} className="flex items-center bg-white py-2 text-[13px] lg:text-[15px] font-jetBrain">
                    <svg className="ml-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                      <path d="M1.52381 16C1.10476 16 0.745906 15.8507 0.447239 15t.552C0.148573 15.s -0.000506643 14.8947 1.29356e-06 14.4762V6.85714C1.29356e-06 6.4381 0.149334 6.07924 0.448001 5.78057C0.746668 5.4819 1.10527 5.33283 1.52381 5.33333H2.28572V3.80952C2.28572 2.75556 2.65727 1.85702 3.40038 1.11391C4.14349 0.370794 5.04178 -0.000507416 6.09524 5.20427e-07C7.14921 5.20427e-07 8.04775 0.371556 8.79086 1.11467C9.53397 1.85778 9.90527 2.75606 9.90476 3.80952V5.33333H10.6667C11.0857 5.33333 11.4446 5.48267 11.7432 5.78133C12.0419 6.08 12.191 6.4386 12.1905 6.85714V14.4762C12.1905 14.8952 12.0411 15.2541 11.7425 15.5528C11.4438 15.8514 11.0852 16.0005 10.6667 16H1.52381ZM6.09524 12.1905C6.51429 12.1905 6.87314 12.0411 7.17181 11.7425C7.47048 11.4438 7.61956 11.0852 7.61905 10.6667C7.61905 10.2476 7.46972 9.88876 7.17105 9.5901C6.87238 9.29143 6.51378 9.14235 6.09524 9.14286C5.67619 9.14286 5.31733 9.29219 5.01867 9.59086C4.72 9.88952 4.57092 10.2481 4.57143 10.6667C4.57143 11.0857 4.72076 11.4446 5.01943 11.7432C5.3181 12.0419 5.6767 12.191 6.09524 12.1905ZM3.80953 5.33333H8.38095V3.80952C8.38095 3.1746 8.15873 2.63492 7.71429 2.19048C7.26984 1.74603 6.73016 1.52381 6.09524 1.52381C5.46032 1.52381 4.92064 1.74603 4.47619 2.19048C4.03175 2.63492 3.80953 3.1746 3.80953 3.80952V5.33333Z" fill="#CCCCCC" />
                    </svg>{' '}
                    <p className="mx-5 cursor-pointer ">Secure</p>
                  </div> */}
                </div>
              </div>
              ...
              <div className="flex-1 flex">
                <p className={`flex-1 flex items-center pt-[1px] font-jetBrain text-dark text-[10px] sm:text-sm lg:text-[15px] border-l border-[#ddd] px-5 bg-white font-bold h-[50px] ${!secure && 'lg:rounded-[0_5px_5px_0]'}`}>{generatedLink}</p>
              ...
              <LinkGenerateButtons classes="hidden lg:flex" message={message} showGenerate={showGenerate} openChat={openChat} showQr={showQr} showQRTip={showQRTip} generatedLink={generatedLink} showCopy={showCopy} handleGenerateTip={handleGenerateTip} handleGenerateTipLeave={handleGenerateTipLeave} handleQrTip={handleQrTip} handleQrTipLeave={handleQrTipLeave} handleCopy={handleCopy} handleCopyLeave={handleCopyLeave} secure={secure} generateLink={generateLink} handleQr={handleQr} copyTOClip={copyTOClip} copyTOClipSecure={copyTOClipSecure} generateLinkSecure={generateLinkSecure} />
            </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-5 pt-[13px] pb-[9px]">
            <div className="w-[300px] hidden lg:block">
              <CloudflareTurnstile />
            </div>
            <div className="grow w-full flex gap-[15px] ">
              ...
              {openChatButton ? (
                <button className="bg-white h-[70px] lg:h-[65px] text-blue hover:text-opacity-80 grow font-jetBrain font-bold text-[14px] rounded-md lg:text-[15px] flex items-center justify-center w-full">Open Chat</button>
              ) : (
                <button onClick={activeButton ? handleChat : handleChatApply} className={`bg-white h-[50px] lg:h-[65px] hover:text-blue ${activeButton ? 'text-blue' : 'text-[#ccc]'} hover:text-opacity-80 grow font-jetBrain font-bold text-[14px] rounded-md lg:text-[15px] flex items-center justify-center w-full`}>
                  Generate Link
                </button>
              )}
            </div>
          </div>
          <p className="text-[11px] ml-[3px] lg:text-[13px] font-medium text-white text-center mt-[5px] pb-[9px]">
            By starting this chat session, you agree to our <Link href={`/terms`} className='underline' >Terms of Use</Link> and <Link href={`/privacy`} className='underline'>Privacy Policy</Link>, and that you and everybody you share the chat link with is above 16 years of age.
          </p>
        </div>
      </div>
      <div onClick={hideSelect} className={`select-overlay fixed inset-0 z-10 bg-white opacity-[0.01] ${selectList ? 'block' : 'hidden'}`}></div>
