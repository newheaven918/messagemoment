...
const LinkGenerateButtons = ({ message, showGenerate, openChat, showQr, showQRTip, generatedLink, showCopy, handleGenerateTip, handleGenerateTipLeave, handleQrTip, handleQrTipLeave, handleCopy, handleCopyLeave, secure, generateLink, handleQr, copyTOClip, copyTOClipSecure, classes, generateLinkSecure }) => {
  return (
    <div className={`buttons pl-[6px] flex gap-[6px] lg:gap-[5px] ${classes}`}>
      <div className="relative">
        <Tooltip showCopy={showGenerate} classes="" message={message} />
        {openChat ? (
          <button onClick={secure ? generateLinkSecure : generateLink} onMouseLeave={handleGenerateTipLeave} className="cursor-pointer h-[50px] w-[50px] flex items-center justify-center border-[1.5px] border-white rounded-[5px] md:hover:bg-dark md:hover:bg-opacity-50">
          ...
          <button onMouseEnter={handleGenerateTip} onMouseLeave={handleGenerateTipLeave} className="cursor-pointer h-[50px] w-[50px] flex items-center justify-center border-[1.5px] border-white border-opacity-20 rounded-[5px] bg-white bg-opacity-20">
            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="22" viewBox="0 0 23 22" fill="none">
      ...
      <div className="relative">
        ...
        <Tooltip showCopy={showQRTip} classes="" message={`Scan QR Code`} />
        {openChat ? (
          <button onClick={handleQr} onMouseLeave={handleQrTipLeave} className="cursor-pointer w-[50px] h-[50px] flex items-center justify-center border-[1.5px] border-white border-opacity-20 rounded-[5px] bg-white md:hover:bg-opacity-60">
          ...
          <button onMouseEnter={handleQrTip} onMouseLeave={handleQrTipLeave} className="cursor-pointer w-[50px] h-[50px] flex items-center justify-center border-[1.5px] border-white border-opacity-20 rounded-[5px] bg-white ">
            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23" fill="none">
      ...
      <div className="relative">
        <Tooltip showCopy={showCopy} classes="" message={message} />
        {openChat ? (
          <button onClick={secure ? copyTOClipSecure : copyTOClip} onMouseLeave={handleCopyLeave} className="cursor-pointer h-[50px] w-[50px] flex items-center justify-center border-[1.5px] border-white border-opacity-20 rounded-[5px] bg-white md:hover:bg-opacity-60">
          ...
          <button onMouseEnter={handleCopy} onMouseLeave={handleCopyLeave} className="cursor-pointer h-[50px] w-[50px] flex items-center justify-center border-[1.5px] border-white border-opacity-20 rounded-[5px] bg-white">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" viewBox="0 0 18 20" fill="none">
